...
void Matrix::setMatrix(float m11, float m12, float m21, float m22, float dx, float dy)
{
    _m11 = m11;
    _m12 = m12;
    _m21 = m21;
...
Matrix &Matrix::shear(float sh, float sv)
{
    float tm11 = sv*_m21;
    float tm12 = sv*_m22;
    float tm21 = sh*_m11;
...
Matrix Matrix::inverted(bool *invertible) const
{
    ...
    if (dtr == 0.0) {
        ...
        if (invertible)
            *invertible = true;
        float dinv = 1.0/dtr;
        return Matrix((_m22*dinv),        (-_m12*dinv),
                       (-_m21*dinv), (_m11*dinv),
...
Matrix Matrix::operator *(const Matrix &m) const
{
    ...
    float tdx  = _dx*m._m11  + _dy*m._m21 + m._dx;
    float tdy =  _dx*m._m12  + _dy*m._m22 + m._dy;
    return Matrix(tm11, tm12, tm21, tm22, tdx, tdy, true);
}
